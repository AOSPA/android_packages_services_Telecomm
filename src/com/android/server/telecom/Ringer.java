...
// QTI_END: 2020-04-08: Telephony: Add vibrating for outgoing call accepted support
    ...
    public boolean startRinging(Call foregroundCall, boolean isHfpDeviceAttached) {
        ...
        try {
            ...
            final int customPattern = Settings.System.getInt(
            ...
            } else if (mUseSimplePattern && customPattern != 0) {
                Log.i(this, "Muted haptic channels to force custom explicit vibration pattern");
                hapticChannelsMuted = true;
